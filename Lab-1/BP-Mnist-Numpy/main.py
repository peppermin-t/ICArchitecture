...
if __name__ == '__main__':
    ...
    np.save('./weights/who.npy', model.weights[2])
    np.save('./weights/whi.npy', model.weights[1])
    np.save('./weights/ofo.npy', model.offsets[2])
    np.save('./weights/ofi.npy', model.offsets[1])
